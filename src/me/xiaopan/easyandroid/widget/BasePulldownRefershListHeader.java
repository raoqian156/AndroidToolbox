...
public abstract class BasePulldownRefershListHeader extends LinearLayout{
	...
	public BasePulldownRefershListHeader(Context context) {
		...
		contentViewHeight = ViewUtils.getMeasuredHeight(contentView);	//测量内容的高度
		contentView.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, contentViewMinHeight));	//设置内容视图的高度为最小高度
